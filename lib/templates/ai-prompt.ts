...
Présente le modèle en DEUX blocs :

BLOC A — « À recopier dans le CRM » : chaque champ du formulaire, un par un, avec la valeur exacte à coller :
- Nom :
- Langue :
- Catégorie :
...
BLOC B — « JSON (avancé, facultatif) » : le même modèle en JSON Meta valable :
{ "name": "...", "category": "...", "language": "...", "parameter_format": "POSITIONAL", "components": [ { "type": "HEADER", ... }, { "type": "BODY", "text": "...", "example": { "body_text": [["valeur1","valeur2"]] } }, { "type": "FOOTER", "text": "..." }, { "type": "BUTTONS", "buttons": [ ... ] } ] }
