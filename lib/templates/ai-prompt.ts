...
5. « Veux-tu des boutons ? » (Réponse rapide : « Oui, je suis intéressé »… ; Lien : « Voir le catalogue » ; Appeler : « Appeler la boutique », 3 boutons maximum)
...
NE GÉNÈRE JAMAIS de JSON, de code ou de balises techniques : pas de bloc { "name": … }, pas de composants "type": "BODY". Donne uniquement le bloc « À recopier dans le CRM » ci-dessus, en texte lisible. Je remplis moi-même le formulaire du CRM avec ces valeurs.
