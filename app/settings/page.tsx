  ...
  return (
    <main className="flex h-dvh flex-col overflow-hidden bg-[var(--chat-canvas)]">
      <div className="min-h-0 flex-1 overflow-y-auto overscroll-contain">
            ...
            <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
              ...
              <div className="flex items-center gap-2 rounded-xl bg-[var(--chat-input)] px-3.5 py-2.5 text-xs text-muted-foreground">
                ...
                <span>
                  ...
                  <span className="ml-1.5 rounded-full bg-emerald-500/10 px-1.5 py-0.5 font-medium text-emerald-700 dark:text-emerald-400">
        ...
        <footer className="mt-8 flex flex-col items-center justify-center gap-1 pb-5 text-xs text-muted-foreground"><span className="flex items-center gap-2"><span className="h-1.5 w-1.5 rounded-full bg-emerald-500" /> <span className="font-medium text-foreground">Kamtech</span> · votre CRM WhatsApp</span><span>Connexion sécurisée par Neon Auth</span></footer>
      </div>
      </div>
          <BottomNav />
    </main>
