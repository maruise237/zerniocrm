          ...
          <div className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <p className="text-[11px] text-muted-foreground">
                Ces tags serviront à cibler les campagnes ; une colonne « tags » du fichier les ajoute par contact.
              </p>
            </div>
            ...
            {!query.isLoading && !query.error && contacts.length === 0 && (
              <div className="rounded-2xl border border-dashed border-[var(--chat-border)] bg-[var(--chat-surface)] p-10 text-center">
                ...
                <p className="mt-1 text-xs text-muted-foreground">
                  Importez un fichier CSV ou Excel, puis ciblez ces contacts par tags dans vos campagnes.
                </p>
